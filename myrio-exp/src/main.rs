...
fn main() -> anyhow::Result<()> {
    ...
    */
    ...
    let clusters = clustering::method_one(myrseqs.clone(), 5, 0.7, 0.6, clustering::cosine_similarity)?;
    ...
    let clusters = clustering::method_two(myrseqs, 5, 0.7, 0.675, clustering::cosine_similarity)?;
